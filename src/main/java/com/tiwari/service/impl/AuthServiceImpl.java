...
import com.tiwari.config.JwtProvider;
...
import com.tiwari.repository.VerificationCodeRepository;
import com.tiwari.response.SignupRequest;
import com.tiwari.service.AuthService;
import com.tiwari.service.EmailService;
import com.tiwari.utils.OtpUtil;
   ...
   private  final EmailService emailService;
    ...
    public void sentLoginOtp(String email) throws Exception {
        ...
        if (email.startsWith(SIGNING_PREFIX)) {
          ...
          if(user == null){
              throw  new Exception("user doesn't exist with provided email");
          }
          ...
          String otp = OtpUtil.generateOtp();
            ...
            String subject = "ECOMZY Login/Signup Otp";
